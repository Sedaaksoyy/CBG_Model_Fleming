...
class Config(object):
    schema = dict(
        ...
        ctx_dc_offset_std={"type": "float", "coerce": float, "default": 0},
        ...
        cortical_beta_mechanism={
            ...
            "coerce": (str, lambda x: x.lower()),
            "default": "current",
            "allowed": ("current", "spikes"),
            },
        # If cortical beta is current modulated
        ...
        # If cortical beta is spike modulated
        ctx_beta_spike_frequency={"type": "float", "coerce": float, "default": 26},
        ctx_beta_synapse_strength={"type": "float", "coerce": float, "default": 0.005},
        ctx_beta_spike_isi_dither={"type": "float", "coerce": float, "default": 5},
        r_matrix={
            "type": "string",
            "coerce": (str, lambda x: x.lower()),
            "default": "identity",
